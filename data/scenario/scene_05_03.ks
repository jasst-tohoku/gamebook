...
_　不具合を見つけやすいテストケースを抽出して、テストケースを減らすためにテスト技法を使うんだよね。理想は入出力の総当たりだけど、それだと工数がいくらあっても足らないから」[l][r]
[r]
...
[r]
「今回は、基本的な処理の不具合は少ないんだけど、複雑な条件の場合に仕様と違う結果を返す場所が多いみたい。今回の仕様はもうちょっとシンプルにできそうな気もするんだけどね……」[l][r]
[r]
_　テスト駆動開発で単体テストを書きながら実装を進めた価値はあったみたいだ。ただし、単体テストは基本的な処理のテストを書いて満足してしまって、複雑な部分がカバーできていなかったようだ。[l][r]

[cm]

「ちょっと量が多くて対応の優先度が高い不具合しか説明できないけど、だいたい他も似た感じだから。納期に間に合わせるには結構頑張らなきゃだけど、よろしくね」[l][r]
@chara_hide name="qa"
[r]
...
[r]
「仕様の上限値とかを入れると起きて、そうじゃない場合は起きないから、分岐の条件が間違っているとかだと思うよ。そのあたりから確認してもらえると早いかも」[l][r]
[r]
...
[r]
「システムの全体的な完成度は良いと思うし、不具合も現象としては重大だけど、原因は割と単純なものが多そう、って印象かな。調べてもらわないと、本当に原因が単純かは分からないけど」[l][r]
[r]
@chara_hide name="qa"
...
*selectC
@jump storage="scene_05_04.ks" target="start"
[s]
