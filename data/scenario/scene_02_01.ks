...
_　試作機はプロジェクト後期、本番機はプロジェクト終盤の完成になるようで、それまでは試作機や本番機と同じCPUアーキテクチャの評価機が用意されるそうだ。[l][r]
...
「きみがテストを自動化すればプロジェクト後期もうまく行くんじゃない？」[l][r]
[r]
_　……はぁ！？[l][r]
...
「プロジェクト初期は余裕があるから試してみればいいよ。[l][playse storage="voice/scene_02_01/manager-02-01-03.ogg"]QA部門はプロジェクト後期から関わるって言ってるから、それまでは考えるつもりはないみたいだ。[l][r]
@playse storage="voice/scene_02_01/manager-02-01-04.ogg"
_　プロジェクト後期の残業まみれを避けられればいいよ」[l][r]
[r]
...
_　プロジェクト中期の実装期間も終わりに近づいてきた開発室に怒声が響く。[l][r]
