...
_　「きみの計画は聞いてたから、間に合わなくなる対策で増員の希望は出してみたんだ。[l][playse storage="voice/scene_02_03/manager-02-03-04.ogg"]だけど、今回の試作機絡みでどこも人手が必要だから、増員の見込みは薄いかもな」[l][r]
[r]
...
「今回は遅れても原因は明らかだから、こっちがどうこう言われることはないだろう。[l][playse storage="voice/scene_02_03/manager-02-03-06.ogg]リリースを遅らせるよう話しておくよ」[l][r]
...
[font color="0xffd700"]Ａ）機能が同等のシミュレーターがあれば、試作機や本番機が１台しかない問題も解決する。仕様が確定したところから順次シミュレータープログラムを作成する。[resetfont][l][r]
[r]
@fadeoutbgm
