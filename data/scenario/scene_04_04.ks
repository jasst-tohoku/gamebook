...
[r]
「分かりました。その分、単体テストをしっかりやる感じですね。ちなみに、中身が無くてテストを通すだけの処理を書く人がいる場合は……」[l][r]
[r]
...
「ここの処理は……もしかして、こういうことですかね。であれば、実装がこんな感じになっているのも納得できますが」[l][r]
[r]
...
「ちょっとこれは、図とかを書かないと混乱しますね。ホワイトボードを席のところまで持ってきますね」[l][r]
[r]
@chara_hide name="leader"
...
[r]
「そうなんですよ。単体テストも通っていないので、実装方法を相談したくて……」[l][r]
[r]
