...
「本番機まで時間ないから、試作機のハードウェア不具合は最優先で確認してほしいみたい。[l][playse storage="voice/scene_02_04/manager-02-04-03.ogg"]できるかな？」[l][r]
[r]
...
「ロジックのミスは無いと思ってますが、そういわれると自信が無いなぁ。[l][playse storage="voice/scene_02_04/mob-02-04-02.ogg"]コード見返してみますね」[l][r]
[r]
